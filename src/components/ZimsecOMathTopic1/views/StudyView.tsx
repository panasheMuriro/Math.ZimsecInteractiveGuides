...
// import BaseConverter from "../interactive/Topic1.5/BaseConverter";
...
// import Base10Explorer from "../interactive/Topic1.5/Base10Explorer";
// import BinaryExplorer from "../interactive/Topic1.5/BinaryExplorer";
    ...
    <div className="min-h-screen bg-[#fdfaf6] text-[#3b3a30] p-6 font-serif">
      <div className="max-w-md mx-auto">
        <div className="bg-[#fffef9] shadow-lg border border-[#e4ded4] rounded-2xl p-6 mb-6">
          ...
          <div className="prose max-w-none overflow-x-auto whitespace-pre-wrap break-words">
            <MathJax>
              {currentContent.content.split("\n").map((paragraph, i) => (
                <p key={i} className="text-gray-900 leading-relaxed mb-4">
                  {paragraph}
