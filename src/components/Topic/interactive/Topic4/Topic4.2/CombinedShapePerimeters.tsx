...
const combinedPerimeterSteps: MultiStep[] = [
  {
    id: 'dimensions_given',
...
$ r = \\frac{d}{2} = \\frac{6}{2} = 3 \\, \\text{cm} $`,
    ...
    CustomContentComponent: CombinedShapeVisualizer,
  },
  {
...
const questions: MultiStepQuestion[] = [
  {
    id: 'combined_perimeter_calculation',
    title: 'Calculate Combined Perimeter',
