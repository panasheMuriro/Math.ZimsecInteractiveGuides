...
//       hint: "Remember to use cube root (∛) for cubic functions",
//       steps: [
//         "y = x³ + 2",
//         "x = y³ + 2",
//         "x - 2 = y³",
...
//     const normalizedCorrect = questions[currentQuestion].answer.replace(
//       /\s+/g,
//       ""
//     );
