...
const base10QuizQuestions: QuizQuestion[] = [
  ...
  {
    question: "What is the expanded form of $245_{10}$ using powers of 10?",
    options: [
  ...
  {
    question: "Which number is represented by $3000 + 400 + 20 + 7$?",
    options: [
      "$3427_{10}$",
      "$3247_{10}$",
      "$30427_{10}$",
  ...
  {
    question: "What is the expanded form of $506_{10}$ showing the value of each place?",
    options: [
      "$500 + 6$",
      "$500 + 0 + 6$",
  ...
  {
    question: "Which number is represented by $1 \\times 10^3 + 5 \\times 10^2 + 9 \\times 10^1 + 6 \\times 10^0$?",
    options: [
      "$1596_{10}$",
      "$1956_{10}$",
      "$10596_{10}$",
  ...
  {
    question: "In the number $3427_{10}$, what is the place value of the digit 4?",
    options: [
      "$4$",
      "$40$",
      "$400$",
  ...
  {
    question: "What is the expanded form of $1024_{10}$ using powers of 10?",
    options: [
