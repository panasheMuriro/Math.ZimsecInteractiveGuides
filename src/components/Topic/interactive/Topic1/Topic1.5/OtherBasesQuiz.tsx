...
const otherBasesQuizQuestions: QuizQuestion[] = [
  ...
  {
    id: 'q1-octal-expanded-powers',
    question: "What is the expanded form of $345_8$ using powers of 8?",
    options: [
      "$3 \\times 8^4 + 4 \\times 8^3 + 5 \\times 8^2$", 
      "$3 \\times 8^2 + 4 \\times 8^1 + 5 \\times 8^0$", 
      "$3 \\times 8^3 + 4 \\times 8^2 + 5 \\times 8^1$", 
      "$3 \\times 8^1 + 4 \\times 8^0 + 5 \\times 8^{-1}$" 
    ],
    correct: 1, 
  ...
  {
    id: 'q2-hex-expanded-values',
    question: "What is $2A3_{16}$ in expanded form showing values?",
    options: [
      "$2 + 10 + 3$",        
      "$512 + 160 + 3$",     
      "$200 + 100 + 3$",     
  ...
  {
    id: 'q3-base5-expanded-to-standard',
    question: "Which base 5 number equals $2 \\times 5^2 + 3 \\times 5^1 + 4 \\times 5^0$?",
    options: [
      "$234_5$", 
      "$432_5$", 
      "$243_5$", 
  ...
  {
    id: 'q4-octal-digits',
    question: "In octal (base 8), what digits can you use?",
    options: [
      "0 to 5",
      "0 to 7",
      "1 to 8",
  ...
  {
    id: 'q5-hex-digit-value',
    question: "What decimal value does the hex digit C represent?",
    options: [
      "10",
      "11",
      "12",
