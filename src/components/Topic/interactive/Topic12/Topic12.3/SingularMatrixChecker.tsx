...
// // //   const [matrix, setMatrix] = useState<(number | string)[][]>([[1, 2], [2, 'k']]);
...
// // //     newMatrix[i][j] = value === 'k' ? 'k' : Number(value) || 0;
// // //     setMatrix(newMatrix);
// // //     setDeterminant(null);
...
// // //         setUnknownValue((a as number) * (d as number) / c);
// // //       } else {
// // //         setUnknownValue(null);
// // //       }
// // //     } else if (d === 'k') {
// // //       // det = a*d - b*c = 0 => a*k - b*c = 0 => k = b*c / a
// // //       if (typeof a === 'number' && a !== 0) {
// // //         setUnknownValue((b as number) * (c as number) / a);
// // //       } else {
// // //         setUnknownValue(null);
// // //       }
// // //     }
...
// // //     } else if (d === 'k') {
// // //       return `${a} \\cdot k - ${b} \\cdot ${c} = 0 \\implies k = \\frac{${b} \\cdot ${c}}{${a}} = ${unknownValue}`;
// // //     }
// // //     return '';
// // //   };
...
// // //       <div className="mb-4">
// // //         <h3 className="text-sm font-semibold text-gray-700 mb-2 text-center">Enter 2×2 Matrix (use 'k' for unknown)</h3>
...
// // //           className="px-3 py-1.5 rounded-md bg-blue-500 text-white font-medium hover:bg-blue-600 transition-all flex items-center gap-1.5 text-sm"
// // //         >
// // //           <X className="w-4 h-4" /> Find k for Singular
// // //         </button>
// // //       </div>
...
// //           Enter 2×2 Matrix {activeTab === 'findK' ? "(use 'k' for unknown)" : ''}
// //         </h3>
// //         <div className="grid grid-cols-2 gap-2 w-32 mx-auto">
// //           {matrix.map((row, i) =>
// //             row.map((value, j) => (
...
// const SingularMatrixChecker: React.FC = () => {
//   const [matrix, setMatrix] = useState<(number | string)[][]>([[1, 2], [2, 4]]);
//   const [determinant, setDeterminant] = useState<number | null>(null);
//   const [unknownValue, setUnknownValue] = useState<number | null>(null);
//   const [activeTab, setActiveTab] = useState<'check' | 'findK'>('check');
...
//     const newMatrix = [...matrix];
//     newMatrix[i] = [...newMatrix[i]];
//     newMatrix[i][j] = activeTab === 'findK' && value.toLowerCase() === 'k' ? 'k' : Number(value) || 0;
//     setMatrix(newMatrix);
//     setDeterminant(null);
//     setUnknownValue(null);
//   };
