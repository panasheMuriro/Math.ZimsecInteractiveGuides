...
const Factorization: React.FC = () => {
  ...
  const generateProblem = (): Problem => {
    const problems: Problem[] = [
      ...
      },
      {
        ...
        lowestPowers: "x^2y^1",
        commonFactor: "4x^2y",
        factorizedForm: "4x^2y(3x - 2y)"
      },
      {
        expression: "15a^3b^2 + 10a^2b^3 - 5ab",
        terms: [
        ...
        lowestPowers: "a^1b^1",
        commonFactor: "5ab",
        factorizedForm: "5ab(3a^2b + 2ab^2 - 1)"
      },
      {
        expression: "18m^4n^2 + 12m^3n^3 + 24m^2n",
        terms: [
        ...
        lowestPowers: "m^2n^1",
        commonFactor: "6m^2n",
        factorizedForm: "6m^2n(3m^2n + 2mn^2 + 4)"
      },
      {
        expression: "20x^3 + 15x^2 - 10x",
        terms: [
          { coeff: 20, vars: { x: 3 } },
          { coeff: 15, vars: { x: 2 } },
          { coeff: -10, vars: { x: 1 } }
  ...
  const checkAnswer = () => {
    ...
    switch(step) {
      ...
      case 2:
        ...
        if (normAnswer === normCorrect || normAnswer === normCorrect.replace('^1', '')) {
          correct = true;
  ...
  const steps = [
    ...
    },
    {
      ...
      instruction: "What are the lowest powers of each variable? (e.g., x^2y^1 or xy)",
      inputType: "text",
      placeholder: "e.g., x^2y or xy",
      field: "lowestPowers"
    },
    {
          ...
          {showSolution && (
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><strong>Lowest powers:</strong> <InlineMath math={currentProblem.lowestPowers} /></p>
                <p><strong>Common factor:</strong> <InlineMath math={currentProblem.commonFactor} /></p>
                <p><strong>Final answer:</strong> <InlineMath math={currentProblem.factorizedForm} /></p>
              </div>
            </div>
          )}
        </div>
