...
// --- Neubrutalism Styles & Colors from the Translation Visualizer ---
const PALETTE = {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold mb-5 flex items-center" style={{ color: PALETTE.darkBlueGreen }}>
        <RotateCcw className="mr-3" size={28} style={{ color: PALETTE.darkBlueGreen }} /> Rotation Visualizer
      </h2>

      {/* Tab Navigation */}
      <div className="flex border-b" style={{ borderColor: PALETTE.darkBlueGreen }}>
        <button
          className={`py-2 px-4 font-semibold transition-colors rounded-t-lg ${
            activeTab === "rotate"
              ? 'bg-off-white text-dark-blue-green rounded-b-none'
              : 'bg-transparent text-white/70 hover:text-white hover:bg-white/10'
          }`}
          style={activeTab === 'rotate' ? { backgroundColor: PALETTE.offWhite, color: PALETTE.darkBlueGreen, border: neubrutalismBase.border, borderBottom: 'none' } : {}}
          onClick={() => setActiveTab("rotate")}
        >
          Rotate Shape
        </button>
        <button
          ...
          style={activeTab === 'find' ? { backgroundColor: PALETTE.offWhite, color: PALETTE.darkBlueGreen, border: neubrutalismBase.border, borderBottom: 'none' } : {}}
          onClick={() => setActiveTab("find")}
        >
          Find Rotation
        </button>
      ...
      >
        {activeTab === "rotate" ? (
          ...
          <>
            <h3 className="text-lg font-semibold mb-3" style={{ color: PALETTE.darkBlueGreen }}>Find Rotation</h3>
      ...
      >
        ...
        {showRotated && (
          <>
            ...
            <div className="mt-3 pt-3 border-t-2" style={{ borderColor: PALETTE.mediumTeal }}>
              <p className="font-semibold mb-2" style={{ color: PALETTE.darkBlueGreen }}>Rotation Matrix:</p>
              <div className="flex justify-center my-2" style={{ color: PALETTE.darkBlueGreen }}>
                <BlockMath math={getRotationMatrix()} />
              </div>

              <p className="font-semibold mb-2 mt-3" style={{ color: PALETTE.darkBlueGreen }}>How Rotation Works:</p>
        ...
        {showCalculatedRotation && (
          <div className="mt-3 pt-3 border-t-2" style={{ borderColor: PALETTE.mediumTeal }}>
            <p className="font-semibold mb-2" style={{ color: PALETTE.darkBlueGreen }}>Calculated Rotation:</p>
