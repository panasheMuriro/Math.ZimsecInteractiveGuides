...
const ProtractorMeasurementTool: React.FC = () => {
  ...
  const NEUBRUTALISM_COLORS = {
    blue: '#0fa3b1',       // Primary - Header, Protractor, Correct Feedback
    lightBlue: '#b5e2fa',  // Secondary - Background Accents, Score Display
    offWhite: '#f9f7f3',   // Background, Cards
    yellow: '#eddea4',     // Highlights, Feedback Backgrounds
    coral: '#f7a072',      // Accents, Incorrect Feedback, Reset Button
    white: '#ffffff',
    slate: '#475569',      // Text, Lines, Vertex
    red: '#e11d48',        // Vertex point
  ...
  return (
    ...
    >
      ...
      {/* Score Display */}
      <div
        className="p-3 flex justify-around  text-center m-3 rounded-xl"
        style={{
      ...
      <div className="p-4">
        ...
        <div className="text-center mb-4">
          ...
          <p
            ...
            style={{ color: NEUBRUTALISM_COLORS.offWhite }}
          >
            Measure This Angle
          </p>
        </div>
        {/* The Angle to Measure */}
        <div
          className="relative rounded-lg border border-slate-200 shadow-inner overflow-hidden"
          style={{ backgroundColor: NEUBRUTALISM_COLORS.offWhite }}
        >
          <svg
            width={containerWidth}
            height={containerHeight}
          ...
          >
            ...
            <path
              d={`
                ...
                A 25 25 0 0 1 
                  ${
                    angleCenter.x -
                    25 * Math.cos((currentAngle * Math.PI) / 180)
                  } 
                  ${angleCenter.y -
                    25 * Math.sin((currentAngle * Math.PI) / 180)}
              `}
              fill="none"
            ...
            >
              <svg width="160" height="120" viewBox="0 0 160 120">
                ...
                <path
                  d="M 20 60 A 60 60 0 0 1 140 60 Z"
                  fill="rgba(15, 163, 177, 0.15)" // Light blue with opacity
          ...
          <div className="mt-4 transition-all duration-300 ease-in-out">
            <div
              ...
              style={{
                ...(feedback.type === "success"
                  ? {
                      backgroundColor: `${NEUBRUTALISM_COLORS.yellow}80`, // Light yellow
                      borderColor: NEUBRUTALISM_COLORS.blue,
                    }
                  : {
                      backgroundColor: `${NEUBRUTALISM_COLORS.coral}80`, // Light coral
                      borderColor: NEUBRUTALISM_COLORS.coral,
                    }),
              }}
            >
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-0.5">
                  {feedback.type === "success" ? (
                    <CheckCircle
                      className="w-6 h-6"
                      style={{ color: NEUBRUTALISM_COLORS.blue }}
                    />
                  ) : (
                    <XCircle
                      className="w-6 h-6"
                      style={{ color: NEUBRUTALISM_COLORS.coral }}
                    />
                  )}
                </div>
                <div className="flex-1">
      ...
      >
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-medium transition-all shadow-md hover:shadow-lg"
          style={{
            ...neubrutalismBase,
        ...
        <button
          ...
          style={{
            ...neubrutalismBase,
            backgroundColor: NEUBRUTALISM_COLORS.coral,
            borderColor: NEUBRUTALISM_COLORS.slate,
            color: NEUBRUTALISM_COLORS.offWhite,
          }}
        >
          <RotateCcw
            className="w-5 h-5"
      ...
      >
        ...
        >
          <li className="flex items-start gap-2">
            <span style={{ color: NEUBRUTALISM_COLORS.blue }}>•</span>
            <span>
              Place protractor center on the{" "}
              <span className="font-semibold" style={{ color: NEUBRUTALISM_COLORS.red }}>
                red vertex point
              </span>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span style={{ color: NEUBRUTALISM_COLORS.blue }}>•</span>
            <span>
              Align the baseline with the{" "}
              <span className="font-semibold">left horizontal line</span>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span style={{ color: NEUBRUTALISM_COLORS.blue }}>•</span>
            <span>
              Read where the angled line crosses the{" "}
          ...
          <li className="flex items-start gap-2">
            <span style={{ color: NEUBRUTALISM_COLORS.blue }}>•</span>
            <span>
              All angles shown are multiples of{" "}
