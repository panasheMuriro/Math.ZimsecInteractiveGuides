        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl">
          ...
          <div className="bg-gradient-to-r from-fuchsia-600 to-pink-600 p-6 text-white relative overflow-hidden">
            ...
            <div className="flex flex-col items-center relative z-10">
              ...
              <p className="text-center text-pink-100 font-medium">
                Calculate your financial growth
              </p>
            </div>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="space-y-2">
              ...
              >
                <span className="bg-fuchsia-500 text-white p-1 rounded-lg mr-2">
                  🏦
                </span>
                Principal Amount (USD)
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-fuchsia-600 font-bold">
                  $
                </span>
                <input
                  id="principal"
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="space-y-2">
              <label
                ...
                className="block text-sm font-medium text-gray-700 flex items-center"
              >
                <span className="bg-pink-500 text-white p-1 rounded-lg mr-2">
                  💹
                </span>
                Interest Rate (% per year)
              </label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-pink-600 font-bold">
                  %
                </span>
                <input
                  id="rate"
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="space-y-2">
              <label
                ...
                className="block text-sm font-medium text-gray-700 flex items-center"
              >
                <span className="bg-blue-500 text-white p-1 rounded-lg mr-2">
                  ⏳
                </span>
                Time Period (Years)
              </label>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <span className="bg-green-500 text-white p-1 rounded-lg mr-3">
                      ✨
                    </span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <span className="bg-emerald-500 text-white p-1 rounded-lg mr-3">
                      🏆
                    </span>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800 flex items-center">
                <span className="bg-yellow-500 text-white p-1 rounded-lg mr-2">
                  🔍
                </span>
                Quick Examples:
              </h3>
