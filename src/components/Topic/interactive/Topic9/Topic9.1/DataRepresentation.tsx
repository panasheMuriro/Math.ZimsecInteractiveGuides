...
//     { name: '0-20', frequency: 5, cumulativeFrequency: 5 },
//     { name: '21-40', frequency: 8, cumulativeFrequency: 13 },
//     { name: '41-60', frequency: 12, cumulativeFrequency: 25 },
//     { name: '61-80', frequency: 10, cumulativeFrequency: 35 },
//     { name: '81-100', frequency: 5, cumulativeFrequency: 40 },
//   ];
...
//     <BarChart width={370} height={300} data={data} margin={{ top: 20, right: 20, left: 0, bottom: 5 }}>
//       <CartesianGrid strokeDasharray="3 3" />
//       <XAxis dataKey="name" />
//       <YAxis />
//       <Tooltip />
//       <Legend />
//       <Bar dataKey="frequency" fill="#82ca9d" barSize={80} />
//     </BarChart>
//   );
...
//       <Tooltip />
//       <Legend />
//       <Line type="monotone" dataKey="frequency" stroke="red" />
//     </LineChart>
//   );
...
//         {['Bar', 'Pie', 'Histogram', 'FrequencyPolygon', 'Ogive'].map((type) => (
//           <button
//             key={type}
